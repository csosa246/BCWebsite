...
function (e, t) {
    ...
    function P(e, t, n) {
        var r, i, o = 0,
            ...
            l = function () {
                if (i) return !1;
                for (var t = Zn || O(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, o = 1 - r, a = 0, l = u.tweens.length; l > a; a++) u.tweens[a].run(o);
        ...
        return ct.map(c, B, u), ct.isFunction(u.opts.start) && u.opts.start.call(e, u), ct.fx.timer(ct.extend(l, {
            elem: e,
            anim: u,
            queue: u.opts.queue
    ...
    function W(e, t, n) {
        ...
        if (!ct.isEmptyObject(c)) {
            d ? "hidden" in d && (p = d.hidden) : d = ct._data(e, "fxshow", {}), o && (d.hidden = !p), p ? ct(e).show() : u.done(function () {
                ct(e).hide()
            }), u.done(function () {
                var t;
            ...
            for (r in c) a = B(p ? d[r] : 0, r, u), r in d || (d[r] = a.start, p && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0))
        }
    }
    ...
    ct.fn = ct.prototype = {
        ...
        init: function (e, n, r) {
            ...
            if ("string" == typeof e) {
                ...
                if (i[1]) {
                    if (n = n instanceof ct ? n[0] : n, ct.merge(this, ct.parseHTML(i[1], n && n.nodeType ? n.ownerDocument || n : G, !0)), mt.test(i[1]) && ct.isPlainObject(n))
    ...
    function (e, t) {
        function n(e, t, n, r) {
            var i, o, a, s, l, u, c, f, h, m;
            if ((t ? t.ownerDocument || t : P) !== $ && L(t), t = t || $, n = n || [], !e || "string" != typeof e) return n;
            ...
            if (_ && !r) {
                ...
                if (C.qsa && (!F || !F.test(e))) {
                    if (f = c = B, h = t, m = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                        for (u = p(e), (c = t.getAttribute("id")) ? f = c.replace(Tt, "\\$&") : t.setAttribute("id", f), f = "[id='" + f + "'] ", l = u.length; l--;) u[l] = f + d(u[l]);
        ...
        function p(e, t) {
            ...
            for (s = e, l = [], u = N.preFilter; s;) {
                (!r || (i = ft.exec(s))) && (i && (s = s.slice(i[0].length) || s), l.push(o = [])), r = !1, (i = pt.exec(s)) && (r = i.shift(), o.push({
                    value: r,
                    type: i[0].replace(ut, " ")
                }), s = s.slice(r.length));
                for (a in N.filter)!(i = yt[a].exec(s)) || u[a] && !(i = u[a](i)) || (r = i.shift(), o.push({
                    value: r,
                    type: a,
                    matches: i
                }), s = s.slice(r.length));
                ...
                if (a) {
                    ...
                    for (; t = t[r];)
                        if (1 === t.nodeType || i)
                            ...
                            } else if (l = u[r] = [c], l[1] = e(t, n, a) || E, l[1] === !0) return !0
            }
        }
        ...
        function y(e, t, n, r, o, a) {
            return r && !r[B] && (r = y(r)), o && !o[B] && (o = y(o, a)), i(function (i, a, s, l) {
                var u, c, f, p = [],
                    d = [],
                    h = a.length,
                ...
                if (i) {
                    if (o || e) {
                        ...
                        for (c = v.length; c--;)(f = v[c]) && (u = o ? nt.call(i, f) : p[c]) > -1 && (i[u] = !(a[u] = f))
                    }
                } else v = g(v === a ? v.splice(h, v.length) : v), o ? o(null, a, v, l) : et.apply(a, v)
            })
        }
            ...
            var r = 0,
                ...
                s = function (i, s, l, u, c) {
                    ...
                    if (m += y, o && y !== m) {
                        ...
                        et.apply(u, h), b && !i && h.length > 0 && m + t.length > 1 && n.uniqueSort(u)
                    }
                    return b && (R = T, j = x), v
                };
            return o ? i(s) : s
        ...
        function w(e, t, n, r) {
            ...
            if (!r && 1 === u.length) {
                if (o = u[0] = u[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && C.getById && 9 === t.nodeType && _ && N.relative[o[1].type]) {
                    if (t = (N.find.ID(a.matches[0].replace(Ct, Et), t) || [])[0], !t) return n;
                    e = e.slice(o.shift().value.length)
                }
                for (i = yt.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !N.relative[s = a.type]);)
                    if ((l = N.find[s]) && (r = l(a.matches[0].replace(Ct, Et), dt.test(o[0].type) && t.parentNode || t))) {
                        if (o.splice(i, 1), e = r.length && d(o), !e) return et.apply(n, r), n;
                        break
                    }
            }
            return A(e, u)(r, t, !_, n, dt.test(e)), n
        }
        var T, C, E, N, k, S, A, j, D, L, $, H, _, F, M, q, O, B = "sizzle" + -new Date,
            P = e.document,
            R = 0,
            W = 0,
            I = r(),
        ...
        try {
            et.apply(Q = tt.call(P.childNodes), P.childNodes), Q[P.childNodes.length].nodeType
        } catch (Nt) {
            et = {
        ...
        S = n.isXML = function (e) {
            ...
            var t = e ? e.ownerDocument || e : P,
                n = t.defaultView;
            return t !== $ && 9 === t.nodeType && t.documentElement ? ($ = t, H = t.documentElement, _ = !S(t), n && n.attachEvent && n !== n.top && n.attachEvent("onbeforeunload", function () {
                L()
                ...
                if (typeof t.getElementById !== J && _) {
                ...
                return typeof t.getElementsByClassName !== J && _ ? t.getElementsByClassName(e) : void 0
            }, M = [], F = [], (C.qsa = vt.test(t.querySelectorAll)) && (o(function (e) {
            ...
            })), (C.matchesSelector = vt.test(q = H.webkitMatchesSelector || H.mozMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)) && o(function (e) {
                C.disconnectedMatch = q.call(e, "div"), q.call(e, "[s!='']:x"), M.push("!=", lt)
            }), F = F.length && new RegExp(F.join("|")), M = M.length && new RegExp(M.join("|")), O = vt.test(H.contains) || H.compareDocumentPosition ? function (e, t) {
                ...
                if (t)
                    for (; t = t.parentNode;)
                        if (t === e) return !0;
                return !1
            }, V = H.compareDocumentPosition ? function (e, n) {
                if (e === n) return U = !0, 0;
                var r = n.compareDocumentPosition && e.compareDocumentPosition && e.compareDocumentPosition(n);
                return r ? 1 & r || !C.sortDetached && n.compareDocumentPosition(e) === r ? e === t || O(P, e) ? -1 : n === t || O(P, n) ? 1 : D ? nt.call(D, e) - nt.call(D, n) : 0 : 4 & r ? -1 : 1 : e.compareDocumentPosition ? -1 : 1
            } : function (e, n) {
                var r, i = 0,
                    o = e.parentNode,
                    a = n.parentNode,
            ...
            if ((e.ownerDocument || e) !== $ && L(e), t = t.replace(ht, "='$1']"), !(!C.matchesSelector || !_ || M && M.test(t) || F && F.test(t))) try {
                var r = q.call(e, t);
            ...
            var r = N.attrHandle[n.toLowerCase()],
                i = r && G.call(N.attrHandle, n.toLowerCase()) ? r(e, n, !_) : t;
            ...
            preFilter: {
                ...
                PSEUDO: function (e) {
                    var n, r = !e[5] && e[2];
                    return yt.CHILD.test(e[0]) ? null : (e[3] && e[4] !== t ? e[2] = e[4] : r && mt.test(r) && (n = p(r, !0)) && (n = r.indexOf(")", r.length - n) - r.length) && (e[0] = e[0].slice(0, n), e[2] = r.slice(0, n)), e.slice(0, 3))
                }
            },
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && v) {
                                for (c = g[B] || (g[B] = {}), u = c[e] || [], d = u[0] === R && u[1], p = u[0] === R && u[2], f = d && g.childNodes[d]; f = ++d && f && f[m] || (p = d = 0) || h.pop();)
                                    if (1 === f.nodeType && ++p && f === t) {
                                        c[e] = [R, d, p];
                                        break
                                    }
                            } else if (v && (u = (t[B] || (t[B] = {}))[e]) && u[0] === R) p = u[1];
                            else
                                for (;
                                    (f = ++d && f && f[m] || (p = d = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== y : 1 !== f.nodeType) || !++p || (v && ((f[B] || (f[B] = {}))[e] = [R, p]), f !== t)););
                ...
                PSEUDO: function (e, t) {
                    ...
                    return o[B] ? o(t) : o.length > 1 ? (r = [e, e, "", t], N.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function (e, n) {
            ...
            pseudos: {
                ...
                lang: i(function (e) {
                    return gt.test(e || "") || n.error("unsupported lang: " + e), e = e.replace(Ct, Et).toLowerCase(),
                    function (t) {
                        var n;
                        do
        ...
        f.prototype = N.filters = N.pseudos, N.setFilters = new f, A = n.compile = function (e, t) {
            var n, r = [],
                i = [],
                o = X[e + " "];
            if (!o) {
            ...
            return o
        }, C.sortStable = B.split("").sort(V).join("") === B, C.detectDuplicates = U, L(), C.sortDetached = o(function (e) {
    ...
    ct.Callbacks = function (e) {
        e = "string" == typeof e ? Nt[e] || r(e) : ct.extend({}, e);
        var n, i, o, a, s, l, u = [],
            c = !e.once && [],
            f = function (t) {
        ...
        when: function (e) {
            ...
            if (a > 1)
                for (t = new Array(a), n = new Array(a), r = new Array(a); a > i; i++) o[i] && ct.isFunction(o[i].promise) ? o[i].promise().done(u(i, r, o)).fail(l.reject).progress(u(i, n, t)) : --s;
        ...
        return t.ownLast = "0" !== c, ct(function () {
            ...
            a && (n = G.createElement("div"), n.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", a.appendChild(n).appendChild(f), f.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", i = f.getElementsByTagName("td"), i[0].style.cssText = "padding:0;margin:0;border:0;display:none", u = 0 === i[0].offsetHeight, i[0].style.display = "", i[1].style.display = "none", t.reliableHiddenOffsets = u && 0 === i[0].offsetHeight, f.innerHTML = "", f.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", ct.swap(a, null != a.style.zoom ? {
                ...
                width: "4px"
            }).width, r = f.appendChild(G.createElement("div")), r.style.cssText = f.style.cssText = o, r.style.marginRight = r.style.width = "0", f.style.width = "1px", t.reliableMarginRight = !parseFloat((e.getComputedStyle(r, null) || {}).marginRight)), typeof f.style.zoom !== J && (f.innerHTML = "", f.style.cssText = o + "width:1px;padding:1px;display:inline;zoom:1", t.inlineBlockNeedsLayout = 3 === f.offsetWidth, f.style.display = "block", f.innerHTML = "<div></div>", f.firstChild.style.width = "5px", t.shrinkWrapBlocks = 3 !== f.offsetWidth, t.inlineBlockNeedsLayout && (a.style.zoom = 1)), a.removeChild(n), n = f = i = r = null)
        }), n = o = a = s = r = i = null, t
    }({});
    var kt = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/,
        St = /([A-Z])/g;
    ...
    ct.fn.extend({
        ...
        toggleClass: function (e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : ct.isFunction(e) ? this.each(function (n) {
                ...
                if ("string" === n)
                    for (var t, r = 0, i = ct(this), o = e.match(pt) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
        ...
        attr: function (e, n, r) {
            ...
            if (e && 3 !== a && 8 !== a && 2 !== a) return typeof e.getAttribute === J ? ct.prop(e, n, r) : (1 === a && ct.isXMLDoc(e) || (n = n.toLowerCase(), i = ct.attrHooks[n] || (ct.expr.match.bool.test(n) ? jt : At)), r === t ? i && "get" in i && null !== (o = i.get(e, n)) ? o : (o = ct.find.attr(e, n), null == o ? t : o) : null !== r ? i && "set" in i && (o = i.set(e, r, n)) !== t ? o : (e.setAttribute(n, r + ""), r) : (ct.removeAttr(e, n), void 0))
        },
        removeAttr: function (e, t) {
            var n, r, i = 0,
                o = t && t.match(pt);
            if (o && 1 === e.nodeType)
                for (; n = o[i++];) r = ct.propFix[n] || n, ct.expr.match.bool.test(n) ? Mt && Ft || !_t.test(n) ? e[r] = !1 : e[ct.camelCase("default-" + n)] = e[r] = !1 : ct.attr(e, n, ""), e.removeAttribute(Ft ? n : r)
        },
        attrHooks: {
            type: {
                set: function (e, t) {
        ...
        propHooks: {
            tabIndex: {
                get: function (e) {
                    ...
                    return t ? parseInt(t, 10) : $t.test(e.nodeName) || Ht.test(e.nodeName) && e.href ? 0 : -1
                }
            }
        }
    }), jt = {
        set: function (e, t, n) {
            return t === !1 ? ct.removeAttr(e, n) : Mt && Ft || !_t.test(n) ? e.setAttribute(!Ft && ct.propFix[n] || n, n) : e[ct.camelCase("default-" + n)] = e[n] = !0, n
        }
    }, ct.each(ct.expr.match.bool.source.match(/\w+/g), function (e, n) {
        var r = ct.expr.attrHandle[n] || ct.find.attr;
        ct.expr.attrHandle[n] = Mt && Ft || !_t.test(n) ? function (e, n, i) {
    ...
    ct.event = {
        ...
        add: function (e, n, r, i, o) {
            var a, s, l, u, c, f, p, d, h, m, g, y = ct._data(e);
            if (y) {
                for (r.handler && (u = r, r = u.handler, o = u.selector), r.guid || (r.guid = ct.guid++), (s = y.events) || (s = y.events = {}), (f = y.handle) || (f = y.handle = function (e) {
                ...
                }, f.elem = e), n = (n || "").match(pt) || [""], l = n.length; l--;) a = Rt.exec(n[l]) || [], h = g = a[1], m = (a[2] || "").split(".").sort(), h && (c = ct.event.special[h] || {}, h = (o ? c.delegateType : c.bindType) || h, c = ct.event.special[h] || {}, p = ct.extend({
                    type: h,
                    origType: g,
                    data: i,
                    handler: r,
                    ...
                    namespace: m.join(".")
                }, u), (d = s[h]) || (d = s[h] = [], d.delegateCount = 0, c.setup && c.setup.call(e, i, m, f) !== !1 || (e.addEventListener ? e.addEventListener(h, f, !1) : e.attachEvent && e.attachEvent("on" + h, f))), c.add && (c.add.call(e, p), p.handler.guid || (p.handler.guid = r.guid)), o ? d.splice(d.delegateCount++, 0, p) : d.push(p), ct.event.global[h] = !0);
                e = null
            }
        },
        remove: function (e, t, n, r, i) {
            var o, a, s, l, u, c, f, p, d, h, m, g = ct.hasData(e) && ct._data(e);
            if (g && (c = g.events)) {
                for (t = (t || "").match(pt) || [""], u = t.length; u--;)
                    if (s = Rt.exec(t[u]) || [], d = m = s[1], h = (s[2] || "").split(".").sort(), d) {
                        for (f = ct.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, p = c[d] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = o = p.length; o--;) a = p[o], !i && m !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || r && r !== a.selector && ("**" !== r || !a.selector) || (p.splice(o, 1), a.selector && p.delegateCount--, f.remove && f.remove.call(e, a));
                        l && !p.length && (f.teardown && f.teardown.call(e, h, g.handle) !== !1 || ct.removeEvent(e, d, g.handle), delete c[d])
                    } else
                        for (d in c) ct.event.remove(e, d + t[u], n, r, !0);
        ...
        fix: function (e) {
            ...
            var t, n, r, i = e.type,
                o = e,
                a = this.fixHooks[i];
            for (a || (this.fixHooks[i] = a = Bt.test(i) ? this.mouseHooks : Ot.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new ct.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
    ...
    sn.optgroup = sn.option, sn.tbody = sn.tfoot = sn.colgroup = sn.caption = sn.thead, sn.th = sn.td, ct.fn.extend({
        ...
        html: function (e) {
            return ct.access(this, function (e) {
                ...
                if (!("string" != typeof e || en.test(e) || !ct.support.htmlSerialize && Jt.test(e) || !ct.support.leadingWhitespace && Yt.test(e) || sn[(Qt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Gt, "<$1></$2>");
                    try {
        ...
        domManip: function (e, t, n) {
            ...
            if (c && (l = ct.buildFragment(e, this[0].ownerDocument, !1, !n && this), r = l.firstChild, 1 === l.childNodes.length && (l = r), r)) {
                for (a = ct.map(x(l, "script"), m), o = a.length; c > u; u++) i = l, u !== p && (i = ct.clone(i, !0, !0), o && ct.merge(a, x(i, "script"))), t.call(this[u], i, u);
                if (o)
        ...
        clone: function (e, t, n) {
            ...
            if (ct.support.html5Clone || ct.isXMLDoc(e) || !Jt.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (un.innerHTML = e.outerHTML, un.removeChild(o = un.firstChild)), !(ct.support.noCloneEvent && ct.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ct.isXMLDoc(e)))
        ...
        buildFragment: function (e, t, n, r) {
            for (var i, o, a, s, l, u, c, f = e.length, p = d(t), h = [], m = 0; f > m; m++)
                if (o = e[m], o || 0 === o)
                    if ("object" === ct.type(o)) ct.merge(h, o.nodeType ? [o] : o);
                    else if (Zt.test(o)) {
                for (s = s || p.appendChild(t.createElement("div")), l = (Qt.exec(o) || ["", ""])[1].toLowerCase(), c = sn[l] || sn._default, s.innerHTML = c[1] + o.replace(Gt, "<$1></$2>") + c[2], i = c[0]; i--;) s = s.lastChild;
                if (!ct.support.leadingWhitespace && Yt.test(o) && h.push(t.createTextNode(Yt.exec(o)[0])), !ct.support.tbody)
                    for (o = "table" !== l || Kt.test(o) ? "<table>" !== c[1] || Kt.test(o) ? 0 : s : s.firstChild, i = o && o.childNodes.length; i--;) ct.nodeName(u = o.childNodes[i], "tbody") && !u.childNodes.length && o.removeChild(u);
                for (ct.merge(h, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
                s = p.lastChild
            } else h.push(t.createTextNode(o));
            for (s && p.removeChild(s), ct.support.appendChecked || ct.grep(x(h, "input"), w), m = 0; o = h[m++];)
                if ((!r || -1 === ct.inArray(o, r)) && (a = ct.contains(o.ownerDocument, o), s = x(p.appendChild(o), "script"), a && y(s), n))
    ...
    ct.fn.extend({
        ...
        style: function (e, n, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, a, s, l = ct.camelCase(n),
                    u = e.style;
                if (n = ct.cssProps[l] || (ct.cssProps[l] = T(u, l)), s = ct.cssHooks[n] || ct.cssHooks[l], r === t) return s && "get" in s && (o = s.get(e, !1, i)) !== t ? o : u[n];
        ...
        css: function (e, n, r, i) {
            var o, a, s, l = ct.camelCase(n);
            return n = ct.cssProps[l] || (ct.cssProps[l] = T(e.style, l)), s = ct.cssHooks[n] || ct.cssHooks[l], s && "get" in s && (a = s.get(e, !0, r)), a === t && (a = pn(e, n, i)), "normal" === a && n in Cn && (a = Cn[n]), "" === r || r ? (o = parseFloat(a), r === !0 || ct.isNumeric(o) ? o || 0 : a) : a
        }
        ...
        ct.cssHooks[t] = {
            get: function (e, n, r) {
                return n ? 0 === e.offsetWidth && gn.test(ct.css(e, "display")) ? ct.swap(e, Tn, function () {
                    return S(e, t, r)
                }) : S(e, t, r) : void 0
            },
            set: function (e, n, r) {
                var i = r && fn(e);
                return N(e, n, r ? k(e, t, r, ct.support.boxSizing && "border-box" === ct.css(e, "boxSizing", !1, i), i) : 0)
            }
        }
        ...
        }, yn.test(e) || (ct.cssHooks[e + t].set = N)
    });
    var kn = /%20/g,
        Sn = /\[\]$/,
        An = /\r?\n/g,
    ...
    try {
        ...
        $n = G.createElement("a"), $n.href = "", $n = $n.href
    }
    Ln = Rn.exec($n.toLowerCase()) || [], ct.fn.load = function (e, n, r) {
        ...
        ajax: function (e, n) {
            function r(e, n, r, i) {
                var o, f, v, b, w, C = n;
                2 !== x && (x = 2, l && clearTimeout(l), c = t, s = i || "", T.readyState = e > 0 ? 4 : 0, o = e >= 200 && 300 > e || 304 === e, r && (b = _(p, T, r)), b = F(p, b, T, o), o ? (p.ifModified && (w = T.getResponseHeader("Last-Modified"), w && (ct.lastModified[a] = w), w = T.getResponseHeader("etag"), w && (ct.etag[a] = w)), 204 === e || "HEAD" === p.type ? C = "nocontent" : 304 === e ? C = "notmodified" : (C = b.state, f = b.data, v = b.error, o = !v)) : (v = C, (e || !C) && (C = "error", 0 > e && (e = 0))), T.status = e, T.statusText = (n || C) + "", o ? m.resolveWith(d, [f, C, T]) : m.rejectWith(d, [T, C, v]), T.statusCode(y), y = t, u && h.trigger(o ? "ajaxSuccess" : "ajaxError", [T, p, o ? f : v]), g.fireWith(d, [T, C]), u && (h.trigger("ajaxComplete", [T, p]), --ct.active || ct.event.trigger("ajaxStop")))
            }
            "object" == typeof e && (n = e, e = t), n = n || {};
            var i, o, a, s, l, u, c, f, p = ct.ajaxSetup({}, n),
                d = p.context || p,
                ...
                T = {
                    ...
                    getResponseHeader: function (e) {
                        ...
                        if (2 === x) {
                            if (!f)
                                for (f = {}; t = qn.exec(s);) f[t[1].toLowerCase()] = t[2];
                            t = f[e.toLowerCase()]
                        }
            ...
            if (m.promise(T).complete = g.add, T.success = T.done, T.error = T.fail, p.url = ((e || p.url || $n) + "").replace(Fn, "").replace(Pn, Ln[1] + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = ct.trim(p.dataType || "*").toLowerCase().match(pt) || [""], null == p.crossDomain && (i = Rn.exec(p.url.toLowerCase()), p.crossDomain = !(!i || i[1] === Ln[1] && i[2] === Ln[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (Ln[3] || ("http:" === Ln[1] ? "80" : "443")))), p.data && p.processData && "string" != typeof p.data && (p.data = ct.param(p.data, p.traditional)), $(In, p, n, T), 2 === x) return T;
            u = p.global, u && 0 === ct.active++ && ct.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Bn.test(p.type), a = p.url, p.hasContent || (p.data && (a = p.url += (_n.test(a) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = Mn.test(a) ? a.replace(Mn, "$1_=" + Hn++) : a + (_n.test(a) ? "&" : "?") + "_=" + Hn++)), p.ifModified && (ct.lastModified[a] && T.setRequestHeader("If-Modified-Since", ct.lastModified[a]), ct.etag[a] && T.setRequestHeader("If-None-Match", ct.etag[a])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && T.setRequestHeader("Content-Type", p.contentType), T.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Xn + "; q=0.01" : "") : p.accepts["*"]);
    ...
    ct.ajaxSetup({
        ...
        return l || "jsonp" === n.dataTypes[0] ? (o = n.jsonpCallback = ct.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, l ? n[l] = n[l].replace(Jn, "$1" + o) : n.jsonp !== !1 && (n.url += (_n.test(n.url) ? "&" : "?") + n.jsonp + "=" + o), n.converters["script json"] = function () {
                    ...
                    l.send(n.hasContent && n.data || null), r = function (e, i) {
                        ...
                        try {
                            if (r && (i || 4 === l.readyState))
                                if (r = t, a && (l.onreadystatechange = ct.noop, Kn && delete Yn[a]), i) 4 !== l.readyState && l.abort();
                                else {
                        ...
                        f && o(s, c, f, u)
                    }, n.async ? 4 === l.readyState ? setTimeout(r) : (a = ++Qn, Kn && (Yn || (Yn = {}, ct(e).unload(Kn)), Yn[a] = r), l.onreadystatechange = r) : r()
                },
                abort: function () {
                    r && r(t, !0)
                }
    ...
    ct.Animation = ct.extend(P, {
        ...
        var n, r, i = {
            ...
            a = o && o.ownerDocument;
        if (a) return n = a.documentElement, ct.contains(n, o) ? (typeof o.getBoundingClientRect !== J && (i = o.getBoundingClientRect()), r = X(a), {
        ...
        setOffset: function (e, t, n) {
            ...
            var i, o, a = ct(e),
                ...
                f = {}, p = {};
            c ? (p = a.position(), i = p.top, o = p.left) : (i = parseFloat(l) || 0, o = parseFloat(u) || 0), ct.isFunction(t) && (t = t.call(e, n, s)), null != t.top && (f.top = t.top - s.top + i), null != t.left && (f.left = t.left - s.left + o), "using" in t ? t.using.call(e, f) : a.css(f)
        }
    }, ct.fn.extend({
        position: function () {
            if (this[0]) {
...
var Froogaloop = function () {
    ...
    function t(e, t, n) {
        ...
        "//" === r.substr(0, 2) && (r = window.location.protocol + r), n.contentWindow.postMessage(e, r)
    }
    ...
    function n(e) {
        ...
        if ("ready" == n && !o && (o = !0), e.origin != a) return !1;
        var e = t.value,
            s = t.data,
            l = "" === l ? null : t.player_id;
        return t = l ? i[l][n] : i[n], n = [], t ? (void 0 !== e && n.push(e), s && n.push(s), l && n.push(l), 0 < n.length ? t.apply(null, n) : t.call()) : !1
    }
    ...
    return e.fn = e.prototype = {
        ...
        init: function (e) {
            ...
            for (var e = e.split("/"), t = "", n = 0, r = e.length; r > n && 3 > n; n++) t += e[n], 2 > n && (t += "/");
            return a = t, this
        },
        api: function (e, n) {
            ...
            return s && r(e, s, o), t(e, a, i), this
        },
        addEvent: function (e, n) {
            if (!this.element) return !1;
            var i = this.element,
                a = "" !== i.id ? i.id : null;
            return r(e, n, a), "ready" != e ? t("addEventListener", e, i) : "ready" == e && o && n.call(null, a), this
        },
        removeEvent: function (e) {
            if (!this.element) return !1;
            var n, r = this.element;
            e: {
                if ((n = "" !== r.id ? r.id : null) && i[n]) {
                    if (!i[n][e]) {
                        n = !1;
                        break e
                    }
            ...
            "ready" != e && n && t("removeEventListener", e, r)
        }
